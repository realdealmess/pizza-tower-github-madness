if (((obj_player1.state == states.normal) || ((obj_player1.state == states.mach1) || ((obj_player1.state == states.mach2) || ((obj_player1.state == states.mach3) || (obj_player1.state == states.Sjump_prep))))) && ((sprite_index == spr_doorkey) && (obj_player1.key_up && ((global.key_inv == 1) && place_meeting(x, y, obj_player1)))))
{
