...
if ((state != enemy_states.walk) && ((state != enemy_states.idle) && (angry == 0)))
{
    grav = 0.5
    vsp = -5
    image_index = 0
...
if ((state != enemy_states.stun) && ((state != enemy_states.grabbed) && ((state != enemy_states.idle) && (state != enemy_states.charge))))
    angry = 0
