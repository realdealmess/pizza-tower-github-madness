...
if (bombreset > 0)
    bombreset--
if ((x != obj_player1.x) && ((obj_player1.state != states.bombpep) && ((state != enemy_states.pizzagoblin_throw) && ((bombreset == 0) && grounded))))
{
...
if instance_exists(obj_player2)
{
    if ((x != obj_player2.x) && ((obj_player2.state != states.bombpep) && ((state != enemy_states.pizzagoblin_throw) && ((bombreset == 0) && grounded))))
    {
